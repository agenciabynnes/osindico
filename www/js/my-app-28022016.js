...
function alertadechegadahome(alvo){
    ...
    destination = [];
    $.ajax({
        url: "http://www.aptohome.com.br/admin/functionAppAlerta.php?idcondominio="+localStorage.getItem("condominioId")+"&action=list",
        dataType : "json",
        success: function(data) {
            if ((data!=null) && (data!="")) {
                ...
                for (var i = 0; i < qtd; i++) {
                    ...
                    dataalerta += '<li class="'+panico+'">'+
                                            ...
                                            '</li>'+
                                            '<li>'+
                                                '<div id="totalalertahome-cont-'+i+'" class="totaldistanciahome bg-blue">'+localStorage.getItem("totalalertahomecont-"+i)+'</div>'+
                                            '</li>';
    ...
    function atualizatempoalerta(ids){
            var qtdtracking = "";
            $.ajax({
                url: "http://www.aptohome.com.br/admin/functionAppTracking.php?idalerta="+ids+"&action=list",
                dataType : "json",
                success: function(data) {
                    if (data!=null) {
                        var qtdtracking = data.tracking.length;
                        console.log(qtdtracking);
                        ...
                        if (origin!=localStorage.getItem("arraytracking")) {
                            atualizatempoalertageo(origin,destination);
    ...
    function atualizatempoalertageo(origin,destination){
            ...
            success: function(data) {
                ...
                if (data!=null) {
                    for (var i = 0; i < qtd; i++) {
                        ...
                        $(totalalertahomecont).html('Distância = ' + totalformat + ' km | Tempo = ' + formatTime(time) + 'min');
                    }
                    alertadechegadahometime = setTimeout(alertadechegadahome, 3000);
                }    
            },error: function(data) {
...
function alertadechegadacont(id){
    ...
    $('#alertadechegadacont-cont').html("");
        ...
        $.ajax({
            url: "http://www.aptohome.com.br/admin/functionAppAlerta.php?idalerta="+id+"&action=list",
            dataType : "json",
            success: function(data) {
                if (data!=null) {
        ...
        // Resultado para quando conseguir capturar a posição GPS...
            ...
            function atualizamap(){
                ...
                console.log("atualizamap");
                    $.ajax({
                        url: "http://www.aptohome.com.br/admin/functionAppTracking.php?idalerta="+localStorage.getItem("idalertadechegadacont")+"&action=list",
                        dataType : "json",
                        success: function(data) {
                            if (data!=null) {
...
myApp.onPageReinit('alertadechegadacont', function (page) {
    ...
    $$('.buttonconcluiralerta').on('click', function(){
        myApp.confirm('Deseja realmente concluir o Aviso de Chegada?', function () {
                ...
                $.ajax({
                    url: "http://www.aptohome.com.br/admin/functionAppAlerta.php?guid="+localStorage.getItem('guidalertadechegadacont')+"&action=deltracking",
                    data : "get",
                    success: function(data) {
    ...
    $$('.buttonalertadechegada').on('click', function(){
        ...
        if (!localStorage.getItem('tracking')) {
            ...
            myApp.confirm('Deseja realmente cancelar o Aviso de Chegada?', function () {
                    ...
                    $.ajax({
                        url: "http://www.aptohome.com.br/admin/functionAppAlerta.php?guid="+localStorage.getItem('guidtracking')+"&action=deltracking",
                        data : "get",
                        success: function(data) {
                            console.log("del tracking");
            ...
            function calculateAndDisplayRoute(directionsService, directionsDisplay) {
                ...
                var onSuccess = function(position) {
                    ...
                    if (localStorage.getItem('tracking')) {
                        ...
                        $.ajax({
                            url: "http://www.aptohome.com.br/admin/functionAppAlerta.php?idmorador="+localStorage.getItem("moradorIdmorador")+"&action=list",
                            dataType : "json",
                            success: function(data) {
                        ...
                        if (!localStorage.getItem('trackingactive')) {
                            ...
                            $.ajax('http://www.aptohome.com.br/admin/functionAppAlerta.php?', {
                                type: "post",
                                dataType: "json",
                                ...
                                localStorage.setItem("trackingactive", true);
                                    ...
                                    /////// inserir coordenadas ///////
                                    /*$.ajax('http://www.aptohome.com.br/admin/functionAppTracking.php?', {
                                        type: "post",
