    ...
    //url+= "&data=" + new Date().getTime();
        ...
        success: function(data){
            ...
            if (data.login.morador && data.login.sindico) {
                //console.log(data.login.morador);
                $$.each(data.login.sindico, function (chave,dados)
                {
                    ...
                    localStorage.setItem("sindicoIdcondominio", dados.bloco.idcondominio);
                    localStorage.setItem("sindicoIdbloco", dados.bloco.idbloco);
                    localStorage.setItem("comdominioNome", dados.condominio.condominio_nome);
                    localStorage.setItem("condominioStreet", dados.condominio.condominio_street);
                    localStorage.setItem("condominioNumber", dados.condominio.condominio_number);
                    localStorage.setItem("condominioDistrict", dados.condominio.condominio_district);
                    localStorage.setItem("condominioCityname", dados.condominio.condominio_cityname);
                    localStorage.setItem("condominioUf", dados.condominio.condominio_uf);
                    ...
                    localStorage.setItem("sindicoGui", dados.morador_guid);
